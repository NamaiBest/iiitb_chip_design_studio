...
# Generated on: Wed Feb 05 18:48:24 IST 2025 (Wed Feb 05 13:18:24 UTC 2025)
...
set logfile fv/t1c_riscv_cpu/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/t1c_riscv_cpu -revised fv_map -use_rtl_names
...
set env(CDN_SYNTH_ROOT) "/mnt/cadence_tools/DDI23.1/GENUS231/tools.lnx86"
set CDN_SYNTH_ROOT      "/mnt/cadence_tools/DDI23.1/GENUS231/tools.lnx86"
set env(CW_DIR) "/mnt/cadence_tools/DDI23.1/GENUS231/tools.lnx86/lib/chipware"
set CW_DIR      "/mnt/cadence_tools/DDI23.1/GENUS231/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /mnt/cadence_tools/DDI23.1/GENUS231/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/mnt/cadence_tools/DDI23.1/GENUS231/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/mnt/cadence_tools/DDI23.1/GENUS231/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/mnt/cadence_tools/DDI23.1/GENUS231/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/mnt/cadence_tools/DDI23.1/GENUS231/tools.lnx86/lib/chipware/sim"
}
...
read_library -liberty -both \
    /home/vlsiuser/Desktop/team_friday_week2/Cadence_design_database_45nm/Cadence_design_database_45nm/synthesis/../lib/slow_vdd1v0_basicCells.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../rtl/t1c_riscv_cpu.v
elaborate_design -golden -root {t1c_riscv_cpu} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/t1c_riscv_cpu/fv_map.v.gz
elaborate_design -revised -root {t1c_riscv_cpu}
...
set_analyze_option -mapping_file fv/t1c_riscv_cpu/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.t1c_riscv_cpu.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.t1c_riscv_cpu.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.t1c_riscv_cpu.rtl.fv_map.rpt
