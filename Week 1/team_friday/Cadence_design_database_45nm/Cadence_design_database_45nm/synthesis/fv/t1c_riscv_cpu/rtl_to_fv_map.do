...
# Generated on: Mon Jan 27 19:13:18 IST 2025 (Mon Jan 27 13:43:18 UTC 2025)
...
set_log_file fv/t1c_riscv_cpu/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/t1c_riscv_cpu -revised fv_map
...
read_library -liberty -both /home/vlsiuser21/Desktop/team_friday/Cadence_design_database_45nm/Cadence_design_database_45nm/synthesis/../lib/slow_vdd1v0_basicCells.lib
...
#add_name_alias fv/t1c_riscv_cpu/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/t1c_riscv_cpu/rtl_to_fv_map.log
}
